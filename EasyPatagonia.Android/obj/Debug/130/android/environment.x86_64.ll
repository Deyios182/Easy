...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"f03920d6-25c8-46de-8e43-5d4ba2f888cb\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [26 x i8] c"com.example.easypatagonia\00", align 16
...
@__XamarinAndroidBundledAssembly_name_105 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_106 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_107 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_108 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_109 = internal global [67 x i8] zeroinitializer, align 16
@__XamarinAndroidBundledAssembly_name_110 = internal global [67 x i8] zeroinitializer, align 16


; Bundled assembly name buffers, all 67 bytes long
@bundled_assemblies = local_unnamed_addr global [111 x %struct.XamarinAndroidBundledAssembly] [
	; 0
	...
	%struct.XamarinAndroidBundledAssembly {
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_105, i32 0, i32 0); name
	}, 
	; 106
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_106, i32 0, i32 0); name
	}, 
	; 107
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_107, i32 0, i32 0); name
	}, 
	; 108
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_108, i32 0, i32 0); name
	}, 
	; 109
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_109, i32 0, i32 0); name
	}, 
	; 110
	%struct.XamarinAndroidBundledAssembly {
		i32 -1, ; apk_fd
		...
		i8* null, ; data
		i32 67, ; name_length
		i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__XamarinAndroidBundledAssembly_name_110, i32 0, i32 0); name
	}
